...
public class PersonIO implements Serializable,Comparable<PersonIO>{
	
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8639665587011562508L;
	
	private List<PetIO> pets=new ArrayList<>();
	private String name;
	private int age;
...
//	}
	...
	public PersonIO addPerson(){
		...
		this.name=newname;
		this.age=newage;
		return new PersonIO(newname,newage);
	}
	...
	public List<PetIO> getPets() {
		return pets;
	}
	public void setPets(List<PetIO> pets) {
		this.pets = pets;
	}
	...
	@Override
	public int compareTo(PersonIO o) {
