...
public class PetIO implements Serializable{
	
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1118115041430402918L;
	private String animal;
	private String Name;
	
	public PetIO(String animal, String name) {
		this.animal = animal;
		Name = name;
	}
