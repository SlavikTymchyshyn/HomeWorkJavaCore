...
/*
 * System.out.print(arraymas[i]); -- ці дві строчки дати десь під
 * "public static void main(String[] args) {" це для виведення масиву array1
 * зробленого методом masiv, можна під любим другим імям масиву
 */
